`ifndef MYCPU_H
    ...
    `define DS_TO_ES_BUS_WD   273
    `define BR_BUS_WD         34
    `define ES_TO_MS_BUS_WD   213
    `define MS_TO_WS_BUS_WD   206
    `define MS_TO_ES_BUS_WD   4
    `define WS_TO_RF_BUS_WD   38
    `define WS_TO_FS_BUS_WD   227
    `define WS_TO_DS_BUS_WD   2
    `define WS_TO_ES_BUS_WD   150
    ...
    `define CSR_DMW0_PLV0     0:0
    `define CSR_DMW0_PLV3     3:3
    `define CSR_DMW0_MAT      5:4
    `define CSR_DMW0_PSEG     27:25
    `define CSR_DMW0_VSEG     31:29
    `define CSR_DMW1_PLV0     0:0
    `define CSR_DMW1_PLV3     3:3
    ...
    `define CSR_TO_EXE_BUS_WD 19
    `define TLB_TO_CSR_BUS_WD 105
    `define CSR_TO_TLB_BUS_WD 108
